...
export const PORTFOLIO_TAB_KEY = "Tab";
export const PORTFOLIO_THUMBNAIL_LIMIT = 8;
export const PORTFOLIO_VIEW_ALL_LABEL = "View all";
export const PORTFOLIO_IMAGES_LABEL = "Portfolio images";
export const PORTFOLIO_VIEWER_IMAGES_LABEL = "Full screen portfolio images";
